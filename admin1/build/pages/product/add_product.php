...
// kichthuoc
// trangthai
    $hoten = $conn->real_escape_string($_POST['tensanpham']);
    $tendangnhap = $conn->real_escape_string($_POST['maloai']);
    $sodienthoai = $conn->real_escape_string($_POST['xuatxu']);
    $vaitro = $conn->real_escape_string($_POST['chatlieu']);
    // $trangthai = isset($_POST['trangthai']) ? 1 : 0;
    
    // Kiểm tra username đã tồn tại chưa
    $check_sql = "SELECT COUNT(*) as count FROM tbl_sanpham WHERE tensanpham = ?";
